...
\begin{frame}{Introduction}
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
      \item The Newman-Penrose (NP) constants are conserved quantities at infinity.
      \item These constants present a comprehensive conservation system for various spins.
      \item Infinite conserved quantities in the linear theory, and ten in the non-linear theory.
      \item Computed as 2-surface integrals at cuts ${C} \approx \mathbb{S}^2$ of null infinity $\mathscr{I}$.
    \end{itemize}
  \end{column}
  \begin{column}{0.5\textwidth}
    ...
    \hfill
    \begin{figure}[h]
      \includegraphics[width=1.0\textwidth]{penrose constants.png} % Make sure your file name matches the actual file.
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \end{align}
        \item Connection between NP and F-frames:
        \begin{align}
          & (\Lambda_{+})^{2} := \Theta^{-1}\kappa^{-1}, \nonumber \\
          & (\Lambda_{-})^{2} := \Theta^{-1}\kappa.
        \end{align}
      \end{itemize}
    \end{column}
    \begin{column}{0.5\textwidth}
      ...
      \begin{figure}[h]
        ...
        \caption{Representation of the compactified Minkowski spacetime.}
      \end{figure}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  \begin{itemize}
    ...
    \end{equation}
    \item Solving \eqref{eq:UnphysicalWaveExplicit} simplifies to:
...
\begin{frame}
  \begin{itemize}
    \item Expanding $\tilde{\phi}$ in terms of the $F$-frame:
...
\begin{frame}{The NP-constants for the spin-0 fields close to $i^0$ \& $\mathscr{I}$}
  \begin{itemize}
    ...
    \end{equation}
    \item Introducing the $f(\tilde{\rho})$-modified NP constants: 
    ...
    \end{align}
    \item For $f(\tilde{\rho})=\tilde{\rho}^2$, we have the "classical NP-constants".
...
\begin{frame}
  \begin{itemize}
    \item To compute the $\ell=0$ NP constant we evaluate at a cut ${C}^{+}$ and use equation \eqref{eq:bmeplus1philm}:
    \begin{align}
...
\begin{frame}{The $i^0$ cylinder logarithmic NP constants at $\mathscr{I}^{-}$}
  \begin{itemize}
    ...
    \item The constants $D_{p;\ell,m}$ that define the regularity condition.
...
\begin{frame}{Conclusions}
  \begin{itemize}
    \item Computed the NP constants for a spin-0 field near spatial and null infinity.
    ...
    \item When the regularity condition, \(D_{p;p,m} = 0\), is unmet, the classical NP constants become undefined.
    ...
    \item While classical NP constants lack correspondence, the \(i^0\) cylinder NP constants at consistently align due to shared origins in the initial data.
  \end{itemize}
\end{frame}
\end{document}
