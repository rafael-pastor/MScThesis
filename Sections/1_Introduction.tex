...
In this representation we can see that the spatial infinity, $i^0$, is mapped to the origin ($T = 0 \rightarrow U = \frac{-\pi}{2}$ and $\psi = \pi \rightarrow V = \frac{\pi}{2}$) and $\mathscr{I}^{\pm}$ and to the future/past null cone through the origin.\\
\begin{figure}[h!]
...
\end{align}
\begin{proposition}\label{prop:operator_phi}
  \begin{align}
