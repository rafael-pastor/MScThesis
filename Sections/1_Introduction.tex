...
\begin{align}\label{eq:operator_phi}
  ...
  & =\sum_{p=0}^{\infty} \sum_{\ell=0}^{p} \sum_{m=-\ell}^{m=\ell} \frac{1}{p !} a_{p;\ell,m}(\tau) \frac{p !}{(p-n) !} p^{p-n} Y_{\ell m} = \sum_{p=0}^{\infty} \sum_{\ell=0}^{p} \sum_{m=-\ell}^{m=\ell} \frac{1}{(p-n) !} a_{p;\ell,m}(\tau) p^{p-n} Y_{\ell m}.
\end{align}
...
\begin{equation}\label{eq:operator_phi_1_2}
  \partial_{\rho}^{n+1} \phi=\sum_{p=0}^{\infty} \sum_{\ell=0}^{p} \sum_{m=-\ell l}^{m=\ell} \frac{1}{(p+n+1) !} a_{p;\ell,m}(\tau) \rho^{p+n+1} Y_{\ell m}, \quad \partial_{\rho}^{n+2} \phi=\sum_{p=0}^{\infty} \sum_{\ell=0}^{p} \sum_{m=-\ell l}^{m=\ell} \frac{1}{(p+n+2) !} a_{p;\ell,m}(\tau) \rho^{p+n+2} Y_{\ell m}.
\end{equation}
...
\begin{align}\label{eq:ODE_wave_JacobiPolytransformed2}
  & \left(\tau^{2}-1\right) \partial_{\tau}^{2}\left[\sum_{p=0}^{\infty} \sum_{\ell=0}^{p} \sum_{m=-\ell}^{m=\ell} \frac{1}{(p-n) !} a_{p;\ell,m}(\tau) \rho^{p-n} Y_{\ell m}\right]-2 \rho \tau \partial_{\tau}\left[\sum_{p=0}^{\infty} \sum_{\ell=0}^{p} \sum_{m=-\ell}^{m=\ell} \frac{1}{(p+n+1) !}a_{p;\ell,m}(\tau)\rho^{p+n+1} Y_{\ell m}\right] - \nonumber \\
  & - 2n\tau\partial_{\tau}\left[\sum_{p=0}^{\infty} \sum_{\ell=0}^{p} \sum_{m=-\ell}^{m=\ell} \frac{1}{(p-n) !} a_{p;\ell,m}(\tau) \rho^{p-n} Y_{\ell m}\right] + \rho^{2}\left[\sum_{p=0}^{\infty} \sum_{\ell=0}^{p} \sum_{m=-\ell}^{m=\ell} \frac{1}{(p+n+2) !} a_{p;\ell,m}(\tau) \rho^{p+n+2} Y_{\ell m}\right] + \nonumber \\
  & + 2n\rho\left[\sum_{p=0}^{\infty} \sum_{\ell=0}^{p} \sum_{m=-\ell}^{m=\ell} \frac{1}{(p+n+1) !} a_{p;\ell,m}(\tau) \rho^{p+n+1} Y_{\ell m}\right] + n(n-1)\left[\sum_{p=0}^{\infty} \sum_{\ell=0}^{p} \sum_{m=-\ell}^{m=\ell} \frac{1}{(p-n) !} a_{p;\ell,m}(\tau) \rho^{p-n} Y_{\ell m}\right] + \nonumber \\
  & + 2\tau\partial_{\tau}\left[\sum_{p=0}^{\infty} \sum_{\ell=0}^{p} \sum_{m=-\ell}^{m=\ell} \frac{1}{(p-n) !} a_{p;\ell,m}(\tau) \rho^{p-n} Y_{\ell m}\right] - \ell(\ell + 1)\left[\sum_{p=0}^{\infty} \sum_{\ell=0}^{p} \sum_{m=-\ell}^{m=\ell} \frac{1}{(p-n) !} a_{p;\ell,m}(\tau) \rho^{p-n} Y_{\ell m}\right] = 0.
\end{align}
Taking $p=n$ gives,
\begin{align}\label{eq:ODE_wave_JacobiPolytransformed3}
  ...
  & + \sum_{p=n}^{\infty} \sum_{\ell=0}^{p} \sum_{m=-\ell}^{m=\ell} \frac{1}{(2p+1)!}\rho^{2p+1} Y_{\ell m}\left[-2\rho\tau \dot{a}_{p;\ell, m}(\tau) + 2p\rho a_{p;\ell, m}(\tau)\right] + \sum_{p=n}^{\infty} \sum_{\ell=0}^{p} \sum_{m=-\ell}^{m=\ell} \frac{\rho^{2}a_{p;\ell,m}(\tau)}{(2p+2)!}\rho^{2p+2} Y_{\ell m} = 0.
\end{align}
Taking $\rho=0$ gets,
